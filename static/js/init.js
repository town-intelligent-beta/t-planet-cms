...
function navbar(group) {
  ...
  if (group == "200" || group == "201") {
    ...
    try {
      ...
      obj_a.innerHTML =
        "<img src='/static/imgs/user.svg' width='30' height='30' class='d-inline-block align-top' alt=''>";
      ...
      obj_dropdown_item_index.innerHTML =
        "<img src='/static/imgs/index.svg' style='width: 25px; height: 25px;'> 首頁管理";
      ...
      obj_dropdown_item_sustainable.innerHTML =
        "<img src='/static/imgs/cooperate.svg' style='width: 25px; height: 25px;'> 永續專區";
      ...
      obj_dropdown_item_AI.innerHTML =
        "<img src='/static/imgs/ai.svg' style='width: 30px; height: 30px;'> AI Eval";
      ...
      obj_dropdown_item_news.innerHTML =
        "<img src='/static/imgs/news.svg' style='width: 25px; height: 25px;'> 最新消息";
      ...
      obj_dropdown_item_contact.innerHTML =
        "<img src='/static/imgs/contact_us.svg' style='width: 25px; height: 25px;'> 聯繫我們";
      ...
      obj_dropdown_item_logout.innerHTML =
        "<img src='/static/imgs/logout.svg' style='width: 25px; height: 25px;'> 登出";
      ...
      obj_dropdown_item_delete.innerHTML =
        "<img src='/static/imgs/delete.svg' style='width: 25px; height: 25px;'> 刪除帳號";
      ...
      var obj_kpi = document.getElementById("kpi");
      for (const child of obj_kpi.children) {
        child.style.display = "none";
      }

      var obj_div_kpi = document.createElement("li");
      obj_div_kpi.className = "nav-item dropdown";

      var obj_a_kpi = document.createElement("a");
      obj_a_kpi.className = "nav-link dropdown-toggle fw-bold";
      obj_a_kpi.href = "#";
      obj_a_kpi.setAttribute("role", "button");
      obj_a_kpi.setAttribute("data-toggle", "dropdown");
      obj_a_kpi.setAttribute("aria-haspopup", "true");
      obj_a_kpi.setAttribute("aria-expanded", "false");
      obj_a_kpi.innerHTML = "永續專案";

      var obj_dropdown_menu_kpi = document.createElement("div");
      obj_dropdown_menu_kpi.className = "dropdown-menu";
      obj_dropdown_menu_kpi.style = "left: -100px;";

      var obj_dropdown_item_index_kpi = document.createElement("a");
      obj_dropdown_item_index_kpi.className = "dropdown-item";
      obj_dropdown_item_index_kpi.href = "/kpi.html";
      obj_dropdown_item_index_kpi.innerHTML = "跨區跨域";

      var obj_dropdown_item_sustainable_kpi = document.createElement("a");
      obj_dropdown_item_sustainable_kpi.className = "dropdown-item";
      obj_dropdown_item_sustainable_kpi.href = "/backend/cms_agent.html";
      obj_dropdown_item_sustainable_kpi.innerHTML = "公司個體";

      obj_dropdown_menu_kpi.appendChild(obj_dropdown_item_index_kpi);
      obj_dropdown_menu_kpi.appendChild(obj_dropdown_item_sustainable_kpi);
      obj_div_kpi.appendChild(obj_a_kpi);
      obj_div_kpi.appendChild(obj_dropdown_menu_kpi);
      obj_kpi.appendChild(obj_div_kpi);
    } catch (e) {
      console.log(e);
    }
  }
